...
public class FunctionLibrary {
	...
	public static WebDriver startBrowser(WebDriver driver) throws Exception{
		...
		if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("Chrome")){
			System.setProperty("webdriver.chrome.driver", "D:\\Karunakar\\StockAccounting_HybridMVN\\Drivers\\chromedriver.exe");
			driver=new ChromeDriver();
		}else if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("firefox")){
			System.setProperty("webdriver.gecko.driver", "D:\\Batch81\\StockAccounting_HybridMVN\\drivers\\geckodriver.exe");
			driver=new FirefoxDriver();
		}else if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("ie")){
			System.setProperty("webdriver.InternetExplorer.driver", "D:\\Batch81\\StockAccounting_HybridMVN\\drivers\\IEDriverServer.exe");
